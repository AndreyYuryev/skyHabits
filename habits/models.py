...
class Habit(models.Model):
    ...
    date = models.TimeField(verbose_name='время действия')
    action = models.CharField(max_length=100, verbose_name='действие')
    pleasant_habit = models.ForeignKey('Habit', on_delete=models.CASCADE,
                                       verbose_name='полезная привычка', **NULLABLE)
    linked_habit = models.ForeignKey('Habit', on_delete=models.CASCADE,
    ...
    execution_time = models.IntegerField(default=0, verbose_name='время на выполнение')
